...
int rmqST::getMinUtil(int segStart, int segEnd, int queryStart, int queryEnd,
		int index) {
...
int main() {
	...
	std::cout << "Min value in the range(1, 5): " << tree->getMin(1, 5)
			<< std::endl;
	std::cout << "Min value of all the elements: "
			<< tree->getMin(0, arr.size() - 1) << std::endl;
	...
	tree->update(5, -2);
	std::cout << "Min value in the range(0, 4): " << tree->getMin(0, 4)
			<< std::endl;
	std::cout << "Min value of all the elements: "
			<< tree->getMin(0, arr.size() - 1) << std::endl;
