...
int rangeMaxST::constructST(std::vector<int> &input, int start, int end,
		int index) {
...
int rangeMaxST::getMaxUtil(int segStart, int segEnd, int queryStart,
...
int rangeMaxST::updateUtil(int segStart, int segEnd, int ind, int val,
		int index) {
