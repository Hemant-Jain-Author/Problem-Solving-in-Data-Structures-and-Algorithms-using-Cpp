...
std::cout<< std::endl;
std::cout << "N = 100, Number of instructions O(n^2):: " << fun3(100); 
std::cout<< std::endl;
std::cout << "N = 100, Number of instructions O(log(n)):: " << fun4(100); 
std::cout<< std::endl;
std::cout << "N = 100, Number of instructions O(log(n)):: " << fun5(100); 
std::cout<< std::endl;
std::cout << "N = 100, Number of instructions O(n^3):: " << fun6(100); 
std::cout<< std::endl;
std::cout << "N = 100, Number of instructions O(n^2):: " << fun7(100); 
std::cout<< std::endl;
std::cout << "N = 100, Number of instructions O(n^(3/2)):: " << fun8(100); 
std::cout<< std::endl;
std::cout << "N = 100, Number of instructions O(n):: " << fun9(100); 
std::cout<< std::endl;
std::cout << "N = 100, Number of instructions O(n^2):: " << fun10(100); 
std::cout<< std::endl;
std::cout << "N = 100, Number of instructions O(n^3):: " << fun11(100); 
std::cout<< std::endl;
std::cout << "N = 100, Number of instructions O(n):: " << fun12(100); 
std::cout<< std::endl;
std::cout << "N = 100, Number of instructions O(n):: " << fun13(100); 
std::cout<< std::endl;
	return 0;
}
/*
