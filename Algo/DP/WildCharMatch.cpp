...
bool matchExpUtil(const std::string &exp, const std::string &str, int m, int n)
{
...
bool matchExpDPUtil(const std::string &exp, const std::string &str, int m, int n)
{
	std::vector<std::vector<bool>> lookup = std::vector<std::vector<bool>>(m + 1, std::vector<bool>(n + 1, false));
