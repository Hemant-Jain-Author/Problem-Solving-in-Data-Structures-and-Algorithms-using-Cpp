...
bool isSafe2(std::vector<std::vector<bool>> &graph, std::vector<int> &colour, int V)
{
	for (int i = 0; i < V; i++)
	{
		for (int j = i + 1; j < V; j++)
...
bool graphColouring2(std::vector<std::vector<bool>> &graph, int V, int m, std::vector<int> &colour, int i)
{
	if (i == V)
	{
...
bool isSafe(std::vector<std::vector<bool>> &graph, int V, std::vector<int> &colour, int v, int c)
{
	for (int i = 0; i < V; i++)
	{
...
bool graphColouringUtil(std::vector<std::vector<bool>> &graph, int V, int m, std::vector<int> &colour, int i)
{
	if (i == V)
	{
		printSolution(colour, V);
